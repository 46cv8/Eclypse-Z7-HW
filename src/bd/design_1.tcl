...
proc create_hier_cell_ZmodDAC_0 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst aresetn_hp
  create_bd_pin -dir I -type rst interconnect_aresetn
  create_bd_pin -dir I -type rst interconnect_aresetn_hp
  create_bd_pin -dir I -type clk m_axi_hp_aclk
  create_bd_pin -dir O -type intr mm2s_introut_ch1
  create_bd_pin -dir O -type intr mm2s_introut_ch2
  ...
  # Create instance: axis_data_fifo_ch2, and set properties
  set axis_data_fifo_ch2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_ch2 ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {4096} \
   CONFIG.FIFO_MEMORY_TYPE {block} \
   CONFIG.IS_ACLK_ASYNC {1} \
  ...
  # Create instance: axis_dwidth_converter_ch2, and set properties
  set axis_dwidth_converter_ch2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwidth_converter_ch2 ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {2} \
 ] $axis_dwidth_converter_ch2
  ...
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_dma_ch1/M_AXI_SG] [get_bd_intf_pins axi_interconnect_dac_hp_0/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_ch2_M_AXIS_MM2S [get_bd_intf_pins axi_dma_ch2/M_AXIS_MM2S] [get_bd_intf_pins axis_data_fifo_ch2/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_ch2_M_AXI_MM2S [get_bd_intf_pins axi_dma_ch2/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_dac_hp_0/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_ch2_M_AXI_SG [get_bd_intf_pins axi_dma_ch2/M_AXI_SG] [get_bd_intf_pins axi_interconnect_dac_hp_0/S03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_dac_gp_0_M02_AXI [get_bd_intf_pins axi_dma_ch2/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_dac_gp_0/M02_AXI]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_ch2_M_AXIS [get_bd_intf_pins axis_data_fifo_ch2/M_AXIS] [get_bd_intf_pins axis_dwidth_converter_ch2/S_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_ch1_M_AXIS [get_bd_intf_pins AXI_ZmodDAC1411_v1_0_0/s_axis_ch1] [get_bd_intf_pins axis_dwidth_converter_ch1/M_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_ch2_M_AXIS [get_bd_intf_pins AXI_ZmodDAC1411_v1_0_0/s_axis_ch2] [get_bd_intf_pins axis_dwidth_converter_ch2/M_AXIS]
  ...
  connect_bd_net -net S03_ARESETN_1 [get_bd_pins aresetn_hp] [get_bd_pins axi_interconnect_dac_hp_0/M00_ARESETN] [get_bd_pins axi_interconnect_dac_hp_0/S00_ARESETN] [get_bd_pins axi_interconnect_dac_hp_0/S01_ARESETN] [get_bd_pins axi_interconnect_dac_hp_0/S02_ARESETN] [get_bd_pins axi_interconnect_dac_hp_0/S03_ARESETN] [get_bd_pins axis_data_fifo_ch1/s_axis_aresetn] [get_bd_pins axis_data_fifo_ch2/s_axis_aresetn]
  ...
  connect_bd_net -net ZmodDAC_aresetn [get_bd_pins aresetn] [get_bd_pins AXI_ZmodDAC1411_v1_0_0/lRst_n] [get_bd_pins axi_dma_ch1/axi_resetn] [get_bd_pins axi_dma_ch2/axi_resetn] [get_bd_pins axi_interconnect_dac_gp_0/M00_ARESETN] [get_bd_pins axi_interconnect_dac_gp_0/M01_ARESETN] [get_bd_pins axi_interconnect_dac_gp_0/M02_ARESETN] [get_bd_pins axi_interconnect_dac_gp_0/S00_ARESETN] [get_bd_pins axis_dwidth_converter_ch1/aresetn] [get_bd_pins axis_dwidth_converter_ch2/aresetn]
  connect_bd_net -net ZmodDAC_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins axi_interconnect_dac_gp_0/ARESETN]
  connect_bd_net -net axi_dma_ch1_mm2s_introut [get_bd_pins mm2s_introut_ch1] [get_bd_pins axi_dma_ch1/mm2s_introut]
  connect_bd_net -net axi_dma_ch2_mm2s_introut [get_bd_pins mm2s_introut_ch2] [get_bd_pins axi_dma_ch2/mm2s_introut]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins m_axi_hp_aclk] [get_bd_pins axi_dma_ch1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_ch1/m_axi_sg_aclk] [get_bd_pins axi_dma_ch2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_ch2/m_axi_sg_aclk] [get_bd_pins axi_interconnect_dac_hp_0/ACLK] [get_bd_pins axi_interconnect_dac_hp_0/M00_ACLK] [get_bd_pins axi_interconnect_dac_hp_0/S00_ACLK] [get_bd_pins axi_interconnect_dac_hp_0/S01_ACLK] [get_bd_pins axi_interconnect_dac_hp_0/S02_ACLK] [get_bd_pins axi_interconnect_dac_hp_0/S03_ACLK] [get_bd_pins axis_data_fifo_ch1/s_axis_aclk] [get_bd_pins axis_data_fifo_ch2/s_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins s_axi_gp_aclk] [get_bd_pins AXI_ZmodDAC1411_v1_0_0/s00_axi_aclk] [get_bd_pins axi_dma_ch1/s_axi_lite_aclk] [get_bd_pins axi_dma_ch2/s_axi_lite_aclk] [get_bd_pins axi_interconnect_dac_gp_0/ACLK] [get_bd_pins axi_interconnect_dac_gp_0/M00_ACLK] [get_bd_pins axi_interconnect_dac_gp_0/M01_ACLK] [get_bd_pins axi_interconnect_dac_gp_0/M02_ACLK] [get_bd_pins axi_interconnect_dac_gp_0/S00_ACLK]
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_pins DacClk] [get_bd_pins ZmodDAC1411_Controll_0/DacClk]
  connect_bd_net -net interconnect_aresetn_hp_1 [get_bd_pins interconnect_aresetn_hp] [get_bd_pins axi_interconnect_dac_hp_0/ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SysClk] [get_bd_pins AXI_ZmodDAC1411_v1_0_0/SysClk] [get_bd_pins ZmodDAC1411_Controll_0/SysClk] [get_bd_pins axis_data_fifo_ch1/m_axis_aclk] [get_bd_pins axis_data_fifo_ch2/m_axis_aclk] [get_bd_pins axis_dwidth_converter_ch1/aclk] [get_bd_pins axis_dwidth_converter_ch2/aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ZmodDAC_0_mm2s_introut [get_bd_pins ZmodDAC_0/mm2s_introut_ch1] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net ZmodDAC_0_mm2s_introut_ch2 [get_bd_pins ZmodDAC_0/mm2s_introut_ch2] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins ZmodDAC_0/m_axi_hp_aclk] [get_bd_pins axi_interconnect_hp_0/ACLK] [get_bd_pins axi_interconnect_hp_0/M00_ACLK] [get_bd_pins axi_interconnect_hp_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  ...
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins ZmodDAC_0/DacClk] [get_bd_pins clk_wiz_0/clk_out4]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports reset_rtl_0_0] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins ZmodDAC_0/interconnect_aresetn] [get_bd_pins axi_interconnect_gp_0/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ZmodDAC_0/aresetn] [get_bd_pins axi_interconnect_gp_0/M00_ARESETN] [get_bd_pins axi_interconnect_gp_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins ZmodDAC_0/interconnect_aresetn_hp] [get_bd_pins axi_interconnect_hp_0/ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins ZmodDAC_0/aresetn_hp] [get_bd_pins axi_interconnect_hp_0/M00_ARESETN] [get_bd_pins axi_interconnect_hp_0/S00_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins xlconstant_1/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ZmodDAC_0/axi_dma_ch2/S_AXI_LITE/Reg] SEG_axi_dma_ch2_Reg
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces ZmodDAC_0/axi_dma_ch1/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces ZmodDAC_0/axi_dma_ch2/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces ZmodDAC_0/axi_dma_ch2/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
